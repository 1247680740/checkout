namespace views.teaRoom.crop
{
	...
	export class CropView extends View
	{
		...
		constructor()
		{
			...
			CropView.cropIconHandler = Handler.create(this, this.cropIconLoadedHandler);
		...
		cropViewMouseOverFn(event?:Event):void
		{
			...
			CropView.cropTip = views.teaRoom.LandView.instance.getChildByName("cropTip") as CropInfoTipUI;
			if(!CropView.cropTip)
				return;
			...
			let landGridView:LandGridView = this.parent as LandGridView;
			if(landGridView)
			{
