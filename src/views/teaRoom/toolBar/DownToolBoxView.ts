namespace views.teaRoom.toolBar
{
	 ...
	 */
	export class DownToolBoxView extends DownToolBoxUI
	{
		curIcon:Image;
		...
		onClkedFn(event:Event):void
		{
			...
			switch(event.target.name)
			{
				case "killWorm": // 除虫
					...
					DownToolBarView.instance.setShowTypeAndState("killWorm",this.killWorm);

					break;
				case "removeGrass":// 除草
					DownToolBarView.instance.setShowTypeAndState("removeGrass",this.removeGrass);

					break;
				case "water":	 // 浇水
					DownToolBarView.instance.setShowTypeAndState("water",this.water);

					break;
				case "grass":	 // 种草
					DownToolBarView.instance.setShowTypeAndState("grass",this.grass);

					break;
				case "worm":	 // 放虫
					DownToolBarView.instance.setShowTypeAndState("worm",this.worm);
