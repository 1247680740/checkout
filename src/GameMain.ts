...
class GameMain
{
     ...
     * 资源配置文件地址
     */
    configUrl: string = "manifest.json?" + Math.random();
    ...
    getPfInfo(): void
    {
        ...
        if (pfObj["uid"])
        {
            ...
            Laya.loader.load(["res/atlas/gameUI/exam.json",
                            ...
                            "res/atlas/gameUI/friendList.json"],
                            Handler.create(this, this.uiAtlasHandler),
                            Handler.create(this, this.loading.progressChanged, null, false),Laya.Loader.ATLAS);
    ...
    resLoaderComplete(seedsObjArr: Array<Object>): void
    {
