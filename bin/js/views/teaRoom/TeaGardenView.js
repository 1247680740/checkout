...
(function (views) {
    ...
    (function (teaRoom) {
        ...
        /**
         * 茶园场景除土地外的其它视图，如：狗、狗窝、狗盆、茶农等
         * @author hsx
         */
        var TeaGardenView = /** @class */ (function (_super) {
            __extends(TeaGardenView, _super);
            function TeaGardenView() {
                var _this = _super.call(this) || this;
                TeaGardenView.instance = _this;
            ...
            TeaGardenView.prototype.addDog = function (swfUrl) {
                // this.dog.url = swfUrl;
            ...
            TeaGardenView.prototype.addFarmer = function () {
            ...
            TeaGardenView.prototype.showFarmerTip = function (event) {
                var farmerMC = event.target;
                if (farmerMC && farmerMC.name == "farmer") {
                    TipLayerManager.tipLayer.showDrawBgTip("工作剩余时间：" + models.teaRoom.TeaGardenModel.teaGardenVO.validTime, new Laya.Point(720, 150));
                }
            };
            /**
             * 添加平常状态的茶农
             ...
             */
            TeaGardenView.prototype.addCommonFarmer = function (url) {
             ...
             * 添加除草或除虫的茶农
             */
            TeaGardenView.prototype.addRemoveGrassWormFarmer = function (url, debuffType, moveTo) {
             ...
             * 添加浇水的茶农
             */
            TeaGardenView.prototype.addWaterFarmer = function (url, debuffType, moveTo) {
                if (debuffType != "water")
                    return;
                var _url = url.substring(0, url.lastIndexOf("."));
                _url += "_water.swf";
            ...
            TeaGardenView.prototype.getMC = function (url, useAtlas) {
            ...
            return TeaGardenView;
        }(laya.ui.View));
        teaRoom.TeaGardenView = TeaGardenView;
    })(teaRoom = views.teaRoom || (views.teaRoom = {}));
})(views || (views = {}));
//# sourceMappingURL=TeaGardenView.js.map